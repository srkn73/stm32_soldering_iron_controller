...
const strings_t strings[LANGUAGE_COUNT] = {
    ...
    [lang_turkish] = {
...
#ifdef ENABLE_ADDON_SWITCH_OFF_REMINDER
      .SWITCH_OFF_REMINDER_Title               = "HATIRLATMA",
      .SWITCH_OFF_REMINDER_EnableDisableOption = "Hatırlatma",
      .SWITCH_OFF_REMINDER_InactivityDelay     = "Gecikme",
      .SWITCH_OFF_REMINDER_ReminderPeriod     = "Süre",
      .SWITCH_OFF_REMINDER_TimeUnit            = "d",
      .SWITCH_OFF_REMINDER_BeepType            = "Bip sesi",
      .SWITCH_OFF_REMINDER_BeepTypes           = {"KISA" ,"ORTA." ,"UZUN"},
#endif

      .IRON_Max_Temp = "Üst Isı",
      .IRON_Min_Temp = "Alt Isı",
      .IRON_Default_Temp = "İlk Isı",
      .IRON_Standby = "Bekle",
      .IRON_Sleep = "Uyku",
      .IRON_Boost = "Darbe",
      .IRON_Boost_Add = " Yükselt",
      .IRON_Wake_Mode = "Uyanma",
      .IRON_Shake_Filtering = " Filtre",
      .IRON_Stand_Mode = " Stantda",
      .IRON_smartActiveEnable = "AKILLI",
      .IRON_smartActiveLoad = " YÜK",
      .IRON_Power = "Güç",
      .IRON_Heater = "Isıtıcı",
      .IRON_ADC_Time = "ADC Süre",
      .IRON_PWM_mul = "PWM mul.",
      .IRON_No_Iron = "Uç yok",
      .IRON_Error_Timeout = "Hata Süre",
      .IRON_Error_Resume_Mode = " Devam Et",
      .IRON_FILTER_MENU = "FİLTRE MENÜ",
      .IRON_NTC_MENU = "NTC MENÜ",

      .FILTER_Filter = "Filtre",
      .FILTER__Threshold = " Eşik",
      .FILTER__Count_limit = " Sayım limit",
      .FILTER__Step_down = " Düşür",
      .FILTER__Min = " Düşük",
      .FILTER_Reset_limit = "Sıfırla",
      ...
      .SYSTEM_LVP = "DVK",
      .SYSTEM_Gui_Time = "Gui süre",
      .SYSTEM_DEBUG = "Uzman",
      .SYSTEM_CLONE_FIX = "Klon düzeltme",
      .SYSTEM_RESET_MENU = "MENÜ SIFIRLA",
      .SYSTEM_Remember = "Hatırla",
      .SYSTEM_RememberLastProfile = " Profil",
      .SYSTEM_RememberLastTip = " Son uç",
#ifdef HAS_BATTERY
      .SYSTEM_RememberLastTemp = " Son ısı",
#endif

      .SYSTEM_DISPLAY_MENU = "EKRAN",
#ifndef ST756
      .DISPLAY_ContrastOrBrightness = "Kontrast",
#else
      .DISPLAY_ContrastOrBrightness = "Kontrast",
      ...
      .DISPLAY_Xflip = "X çevir",
      .DISPLAY_Yflip = "Y çevir",
      .DISPLAY_Ratio = "oran",
      .DISPLAY_Dim = "Karart",
      .DISPLAY_Dim_inSleep = " Uyku",
      .DISPLAY_Advanced = "GELİŞMİŞ",
